            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <button id="backlist" class="btn btn-primary btn-sm"><i class="fa fa-arrow-left"></i> 返回列表</button>
                    </div>
                </div>
                <div class="box-body">
 ...
 <script>
 	$(function(){
 		...
 		$("#backlist").click(function(){
 			window.location.href = "/customer/list?"+addurl;
 		})
 		$("#save").click(function(){
			...
			submitHandler : function(form){
				$.ajax({
					...
					success : function(data){
						//保存成功后，如果accountId=0,则跳转公海list,否则跳转当前用户list
						if(data.data==0){
