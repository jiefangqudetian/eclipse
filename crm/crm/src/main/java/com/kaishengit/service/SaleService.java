...
public class SaleService {
	...
	/**保存saleChance要改动三个表，t_customer sale_chance sale_chance_record
	 * @param saleChance
	 */
	...
	/**
	 * 1.判断saleid是否为纯数字
	 * 2.判断saleid是否合法，是否存在对应的saleChance对象
	...
	public List<SaleChance> findSaleChanceListByCustId(int id) {
		// TODO Auto-generated method stub
		return saleDao.findListByCustId(id);
	}

	public List<Map<String, Object>> countSaleProcess(int accountId) {
		// TODO Auto-generated method stub
		return saleDao.countProcessByaccId(accountId);
	}
