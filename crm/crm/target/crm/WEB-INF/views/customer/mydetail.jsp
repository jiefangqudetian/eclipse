        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
						<a href="/customer/list" class="btn btn-primary btn-sm" ><i class="fa fa-arrow-left"></i> 返回列表</a>
                        <a class="btn bg-purple btn-sm" href="/customer/edit?id=${customer.id}"><i class="fa fa-pencil"></i> 编辑</a>
	      ...
	      <div class="modal-body">
	       		...
	       		<select id="accountList" class="form-control" style="width:100%">
		       		<c:forEach items="${accountList}" var="account">
		       			<c:if test="${account.id != 1 and account.id != customer.accountId}">
	...
	$(function(){
		...
		$("#delBtn").click(function(){
			layer.confirm("确定要删除该客户么?",function(){
				layer.close();
				location.href="/customer/del?custId=" + custId ;					
			});
		});
		//放入公海
		$("#publicBtn").click(function(){
			layer.confirm('确认要放入公海么', {
				  btn: ['确认','取消'] //按钮
				}, function(){
					$.ajax({
			  		   type: "POST",
			  		   url: "/customer/my/public",
			  		   data: {
				        	"id":custId
				        },
			  		   success: function(){
