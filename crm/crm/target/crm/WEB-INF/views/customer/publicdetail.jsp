        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
						<a href="/customer/list?ispublic=true" class="btn btn-primary btn-sm" ><i class="fa fa-arrow-left"></i> 返回列表</a>
                        <a class="btn bg-purple btn-sm" href="/customer/edit?id=${customer.id}"><i class="fa fa-pencil"></i> 编辑</a>
                        <a class="btn bg-maroon btn-sm" id="confirm" href="javascript:;"><i class="fa fa-recycle"></i> 认领</a>
				...
				layer.confirm('确认要认领么', {
	 				  btn: ['确认','取消'] //按钮
	 					...
	 					$.ajax({
	 			  		   ...
	 			  		   success: function(){
	 			  			 layer.msg("认领成功");
	 			  			 window.location.href ="/customer/list?ispublic=true";
