...
<jsp:include page="../include/sider.jsp">
	<jsp:param value="customer_${name}" name="param"/>
</jsp:include>
    <!-- =============================================== -->
 ...
 <script>
 	$(function(){
 		...
 		$("#addBtn").click(function(){
 	 		window.location.href = "/customer/add?"+addurl; 
 	 	});
 		//客户详情页
 		$(".datarow").click(function(){
 			var custId = $(this).attr("rel");
 			window.location.href = "/customer/detail?id="+custId+"&"+addurl;
 		});
 		//点击分页页码
 		 $("#pagination").twbsPagination({
 	         totalPages:"${page.totalpage}",
 	         visiblePages:3,
 	         href:"/customer/list?p={{number}}&"+addurl,
 	         first: "首页",
 	         prev: "上一页",
 	         next:"下一页",
 	         last:"末页"
